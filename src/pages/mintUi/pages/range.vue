<template>
  <div class="page-range">
    ...
    <mt-cell v-for="item in cells1" :key="item.$index" :title="item.title" :label="'value:' + item.value">
    ...
    <mt-cell v-for="item in cells2" :key="item.$index" :title="item.title" :label="'value:' + item.value">
    ...
    <mt-cell v-for="item in cells3" :key="item.$index" :title="item.title" :label="'value:' + item.value">
